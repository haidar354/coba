...
const SurveyForm = ({
  ...
  const generateCustomSurveyResponses = (questions) => {
    const responses = [];
    ...
    questions.forEach((question, index) => {
      ...
      responses.push({
        ...
        score: parseInt(data),
        surveyor_name: surveyData.name,
        surveyor_details: surveyData.feedback,
      });
    });
  ...
  const handleSubmit = async () => {
    ...
    console.log("isSurveyId:", isSurveyId);
    console.log("isSurveyId:", question);
    console.log(generateCustomSurveyResponses(question));
    console.log({
      response: {
        survey_id: isSurveyId,
      },
    });
    // setIsloadingQuestion(true);
    // try {
    //   const response = await api.post(`api/academic/responses/bulk`, {
    //     response: {
    //       survey_id: isSurveyId,
